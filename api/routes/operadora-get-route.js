module.exports = function (app, db) {
  ...
  app.get("/api/operadora/id/:codoperadora", (req, res) => {
    processData(
      res,
      "SELECT * FROM operadora where codoperadora == " + req.params.codoperadora
    );
  });
  ...
  app.get("/api/operadora/:nome/:categoria", (req, res) => {
    processData(
      res,
      "SELECT * FROM operadora where " +
        req.params.nome +
        " = '" +
  ...
  app.get("/api/operadoras", (req, res) => {
    processData(res, `SELECT o.* FROM Operadora O`);
  });
