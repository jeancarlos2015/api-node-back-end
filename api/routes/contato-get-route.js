module.exports = function(app, db) {
    ...
    app.get('/api/contato/id/:serial', (req, res) => {
      processData(res, "SELECT * FROM Contato where serial == "+req.params.serial);
    });
    ...
    app.get('/api/contato/:attribute/:name', (req, res) => {
      processData(res, "SELECT * FROM contato where "+req.params.attribute+" = '"+req.params.name+"'");
    });
  
    // Load all products: http://localhost:4300/api/product/
    app.get('/api/contatos', (req, res) => {
      processData(res, "SELECT * FROM contato");
    });
